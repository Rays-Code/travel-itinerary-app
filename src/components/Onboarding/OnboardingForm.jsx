...
const OnboardingForm = () => {
  ...
  return (
    <div className='flex flex-col gap-9 top-[53px] left-[20px] text-[#0B0809]'>
        ...
        <img src='/assets/images/akar-icons_location.png' className='absolute p-2 block dark:hidden'/> 
        ...
        {/* Calendar Icon */}
        <img src="/assets/images/uil_calendar.png" className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 block dark:hidden" />
        <img src="/assets/images/uil_calendar-dark.png" className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 hidden dark:block" />
